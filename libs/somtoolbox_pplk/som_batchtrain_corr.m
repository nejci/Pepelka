function [sMap,sTrain] = som_batchtrain_corr(sMap, D, varargin)
% Pearson Correlation used as similarity metric!!!
% NOTES:
...
% varargin
sTrain = som_set('som_train','algorithm','batch','distfun','correlation','distmode','euc','neigh', ...
