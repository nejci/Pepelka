function [sMap,sTrain] = som_batchtrain_dotprod(sMap, D, varargin)
...
% varargin
sTrain = som_set('som_train','algorithm','batch','distfun','ucorrelation','distmode','dotprod','neigh', ...
