function [sMap,sTrain] = som_batchtrain_ucorr(sMap, D, varargin)
...
% varargin
sTrain = som_set('som_train','algorithm','batch','distfun','ucorrelation','distmode','euc','neigh', ...
...
% racunanje korelacije
% pripravi podatke - izvedi transformacijo nevronov vnaprej
