function sMap = som_nejcinit(D, varargin)
...
while i<=length(varargin), 
  ...
  if ischar(varargin{i}), 
    switch varargin{i}, 
     ...
     %dodal Nejc Ilc
     case 'pca_vec', i=i+1; pca_vec=varargin{i};
...
% 
%   %dodal Nejc Ilc namesto zgornje kode - dela hitreje in stabilneje
%   for i=1:dim, 
%      me(i) = mean(D(isfinite(D(:,i)),i)); 
%      D(:,i) = D(:,i) - me(i); 
%   end 
...
% take first munits data points for neurons position
sMap.codebook = D(1:munits,:);
