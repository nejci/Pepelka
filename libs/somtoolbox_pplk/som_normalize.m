...
%                     'var', 'range', 'log', 'logistic', 'histD', 'histC' or 'propor'. 
...
% Modified by Nejc - added 'proportional' rescaling
...
if nargin<2 || isempty(method), 
  ...
  if ischar(method),
    switch method, 
    case {'var','range','log','histD','histC','logistic','propor'}, 
