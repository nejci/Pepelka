...
while i<=length(varargin), 
  ...
  if ischar(varargin{i}), 
    switch varargin{i}, 
	 ...
	 case 'distfun',	i=i+1; sTrain.distfun = varargin{i}; % addded by Nejc Ilc
	 case 'distmode',	i=i+1; sTrain.distmode = varargin{i}; % addded by Nejc Ilc
	 case 'bmus',		i=i+1; sTrain.bmus = varargin{i}; % addded by Nejc Ilc	 
	...
	sTprev = varargin{i}; 
	 ...
	 case {'sqEuclidean','correlation','ucorrelation'}, sTrain.distfun = varargin{i};
     otherwise argok=0; 
    end
  elseif isstruct(varargin{i}) & isfield(varargin{i},'type'), 
    switch varargin{i}.type, 
     case 'som_train', 
	  ...
	  if ~isempty(sT.distfun),    sTrain.distfun = sT.distfun; end % addded by Nejc Ilc
	  if ~isempty(sT.distfun),    sTrain.distmode = sT.distmode; end % addded by Nejc Ilc
	  if ~isempty(sT.bmus),		  sTrain.bmus = sT.bmus; end % addded by Nejc Ilc
