...
function [labels,IC]=CSC(data,sigh,Kf,Kin,Nin)
...
function [l,ul,KM]=seed(data,sig,Kin,Nin,fig)
    ...
    for i = 1:Kin;
        ...
        KM(:,i) = mean(data(index(1:Nin),:),1)'; % mean
