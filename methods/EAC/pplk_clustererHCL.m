function [labels, moreInfo]=pplk_clustererHCL(S,K,clustMethod,distMethod)
...
%
% clustMethod: method for hierarchical clustering; choices are:
...
%
% distMethod: when S is a data matrix, this parameter must be specified
...
if ~exist('clustMethod','var') || isempty(clustMethod)
    clustMethod = 'single';
end
