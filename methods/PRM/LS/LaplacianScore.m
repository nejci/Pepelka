...
%	W: The affinity matrix (use constructW).
...
%
%   Deng Cai, 2004/08
%   Adaptation by Nejc Ilc 2013/06
...
%feaNorm = NormalizeFea(iris(:,1:4),2);
%fea = iris(:,1:4) ./ repmat(max(1e-10,feaNorm),1,4);
fea = NormalizeFea(iris(:,1:4),2);
