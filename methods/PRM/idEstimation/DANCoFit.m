...
% add path to Curve fitting toolbox distributable
modelFileName = 'DANCo_fits';
hasLicence = license('test','Curve_Fitting_Toolbox');
if ~hasLicence
    addpath('curveFitDist');
    modelFileName = 'DANCo_fits2';
end
