function [clusts,distortion]=gcutOrig(A,nClusts,KMruns,KMiters)
...
%%%%%%%%%%%%%%%%%% Kmeans
%%%%%% Try KMruns runs of k-means and save the one with minimal distortion
...
for nRuns=1:KMruns
    ...
    %%%%%%%%%%% and now run K means
    for tt=1:KMiters   %% KMiters iterations for kmeans
