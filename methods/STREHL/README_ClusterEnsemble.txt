...
ensemble algorithms as described in
      ...
      Edmonton, Canada, pp. 93-98
To use it copy all eleven files
      ClusterEnsembleTest.m
      README_ClusterEnsemble.txt
      ceevalmutual.m
      clbtocl.m
      clstoclbs.m
      cltoclb.m
...
your MATLAB environment. Also, make sure that you have CLUSTERBASICS
installed. Then, in MATLAB just type
      clusterensemble;
to get an illustrative example or
      help clusterensemble
to get help on the usage of the function.
It has been tested on LNX86 5.2.0.3084.
----------------------------------------------------------------------
...
This package and potential updates are available from
      http://strehl.com
----------------------------------------------------------------------
Finally, copyright (c) 1998-2002 by Alexander Strehl. All rights
