function [labels, moreInfo]=pplk_clustererSL(data,K,params)

% params.SL_distance can be:
...
if exist('params','var') && isstruct(params) && isfield(params,'SL_distance')
    dist=params.SL_distance;
else
	dist='euclidean';
end
