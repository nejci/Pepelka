function [XB,XBmod] = indexXB2(data,labels)
...
distCenter2Data = pdist2(clusterCenters,data,'euclidean').^2;
...
distCenter2Center = squareform(pdist(clusterCenters,'euclidean').^2);
